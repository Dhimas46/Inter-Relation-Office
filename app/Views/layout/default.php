    ...
    <div class="main-wrapper">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            <a href="<?= base_url('') ?>">
            <img src="<?= base_url('') ?>/load_home/images/logo.png" width="230" height="55">
          </a>
          </div>
        </form>
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="<?= base_url(); ?>/image/<?= user()->image; ?>" class="rounded-circle mr-1">
            <div class="d-sm-none d-lg-inline-block">Hi, <?= user()->username; ?></div></a>
            <div class="dropdown-menu dropdown-menu-right">
              <div class="dropdown-title">menu</div>
              <a href="<?=base_url('profil/'.user()->id) ?>" class="dropdown-item has-icon">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= site_url('dashboard') ?>">IRO</a>
          </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2022 <div class="bullet"></div> Developed By <a href="">Dhimas Wahyu Prayogi</a>
        </div>
